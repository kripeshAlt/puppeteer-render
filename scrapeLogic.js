...
const scrapeLogic = async (res) => {
  ...
  try {
    ...
    aawait page.goto('https://99faucet.com/login');
    ...
    await page.evaluate(async () => {
        await new Promise((resolve) => {
          const distance = 5000; // Large distance to scroll quickly
          const interval = 50; // 50ms interval to reach the bottom in about 1 second
          let totalHeight = 0;
          ...
          const timer = setInterval(() => {
            ...
            // Stop when we reach the bottom of the page
